...
The **Help** menu opens the data directory and the log directly; the in-window error page
also shows the log path.
...
- CI (GitHub Actions) builds a three-platform matrix (Windows/macOS/Linux): pushes build
  artifacts, `v*` tags automatically publish a Release with all installers.
